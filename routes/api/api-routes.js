...
app.post('/get-user-details', async (req, res) => {
  let { username } = req.body,
    ...
    details = await db.query(
      'SELECT id, username, firstname, surname, email, bio, joined, email_verified, account_type, instagram, twitter, facebook, github, website, phone, completed, lastOnline FROM users WHERE username=?',
      [username]
    ),
